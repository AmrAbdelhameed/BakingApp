...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.example.amr.bakingapp.NewAppWidget";
        ...
        mAPIService.getBaking().enqueue(new Callback<List<BakingResponse>>() {
            ...
            public void onResponse(Call<List<BakingResponse>> call, Response<List<BakingResponse>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    SharedPreferences sharedPreferences = NewAppWidgetConfigureActivity.this.getSharedPreferences("sharedPreferences_name", Context.MODE_PRIVATE);
